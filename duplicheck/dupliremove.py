...
def removedupli( thirdmesh, schema,  tablename, dbhost, dbname, dbuser, dbpasswd, filename  ):
...
if __name__ == "__main__":
    import dupliremoveschemems

    #print("initializing...")

    args = dupliremoveschemems.ARGSCHEME.parse_args()
...
#    ovlsep  = './workfiles/ovlsplit/'
    ...
    removedupli( thirdmesh, schema,  tablename,  dbhost, dbname, dbuser, dbpasswd, filename )
    #print( dbhost)
    #print(dbname)
