...
def  output_sql( secondmesh ):
     ...
     print("create view \"4thmesh\".\"" +secondmesh + "\"" )

     print( "as" )

     print( "select  \"L2mesh\".\"" + secondmesh + "\".ogc_fid," )

     print( "\"L2mesh\".\"" + secondmesh + "\".wkb_geometry, \"L2mesh\".\"" + secondmesh + "\".code  ," )
     print ( " coalesce(\"groupstats\".\"" + secondmesh + "\".count , 0 )  d5mmesh," )
     print ( "coalesce(\"groupstats\".\"" + secondmesh + "\".count,0)/10000.0 dratio  , ")
     print ( "coalesce(\"census2015\".\"" + firstmesh +  "\".sousu,0) as jinko, ")
     print( "coalesce(\"census2015\".\"" + firstmesh + "\".sousu,0) * coalesce(\"groupstats\".\"" + secondmesh + "\".count,0)/10000.0 soutei_jinko ")
     print( "from    \"L2mesh\".\"" + secondmesh + "\" left outer  join  \"groupstats\".\"" + secondmesh + "\" " )  
     print( "on  \"L2mesh\".\"" + secondmesh  + "\".code =  to_number(\"groupstats\".\"" + secondmesh + "\".fcode, '999999999') ")
     print( "left outer join  \"census2015\".\"" + firstmesh + "\" on " )
     print( "\"L2mesh\".\"" + secondmesh + "\".code =  to_number(\"census2015\".\"" + firstmesh + "\".key_code, '999999999') ;" )
 

if __name__ == "__main__":
    import createstatschema

    #print("initializing...")

    args = createstatschema.ARGSCHEME.parse_args()
