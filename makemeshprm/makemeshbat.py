...
def Create5mandMesh_wlist( param, output_file , meshlist, toolfolder, meshlevel):
#def  Create5mandMesh( param, output_file , meshlevel ):
...
if __name__ == "__main__":
    import makemeshbatschemes

    #print("initializing...")

    args = makemeshbatschemes.ARGSCHEME.parse_args()
    ...
    try:
        with open(configfile, 'r') as json_open:
             ...
             Create5mandMesh_wlist( param, output_file , meshlist, toolfolder, 3)
