...
def   checkShapeFile( inputfile  , outputfile, resultfile):
    ...
    dataSource = ogr.Open(daShapefile  ,0)
    ofile = sys.stdout
        ...
        #print(keyname )
            ...
            #print( feature. GetField(keyname))
                    ...
                    if isinstance(tgdata, int):
                        ...
                        result_str =  str(tglength)+ "," + toUnicode(inputfile) +  "," +" keyname" + ",,type float \n"
                        ...
                        result_str =  str(tglength)+ "," + inputfile +  "," + keyname + ",,type unknown \n"
            ...
            tglength  = -1
            output_str = str(tglength)+ "," + inputfile + "\n"
            ...
            result_str =  str(tglength)+ "," + inputfile +  "," + keyname + ","+ str(tgdata) + ",no field \n"
